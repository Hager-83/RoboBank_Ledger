...
/*************** 6.Bank Summary **************/
bank_summary(tx_type, tx_amount_cents, tx_count, ac_balance, ac_count,
 out_total_deposits, out_total_withdrawals, out_total_fees, out_total_interest,
 out_net_exposure)
 {

    for(auto i =0; i<ac_count ; )
 }
