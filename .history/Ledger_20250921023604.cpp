...
void apply_one( int ac_balance[], int ac_capacity, int& ac_count, string account_id,int tx_type,unsigned int amount_cents)
/*************** 3. Apply One Transaction **************/
void apply_all(string tx_account_id[], int tx_type[],int tx_amount_cents, int& tx_count, string account_id,
 ac_balance, ac_capacity, ac_count
