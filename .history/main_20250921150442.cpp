...
string    ac_account_id[ac_capacity] = {"A00", "A01", "A02", "A03", "A04"};
unique_ptr<string> account_id = make_unique<string>();
        ...
        switch(operation)
        {
            ...
            case 4: /** Apply All Transactions  **/
            {
                ...
                for (auto i =0; i<tx_count; i++)
                {
                    ...
                    apply_all(tx_account_id.get(), tx_type.get(), tx_amount_cents, tx_count,ac_account_id, ac_balance, ac_capacity, no_of_accounts);
