...
void bank_summary(int ac_count, int ac_balance[], int *out_total_deposits, int *out_total_withdrawals,int * out_total_fees,int * out_total_interest,int& out_net_exposure )
 {
    ...
    cout << "out total_deposits    = " <<out_total_deposits<<endl;  
    cout << "out_total_withdrawals = " <<out_total_withdrawals<<endl;  
    cout << "out_total_fees        = " <<out_total_fees<<endl;  
    cout << "out_total_interest    = " <<out_total_interest<<endl;  
