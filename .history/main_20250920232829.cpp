...
int       ac_balance[] = {5000, 1500, 3000, 700};
...
int main()
{
    while(true)
    {
        ...
        switch(operation)
        {
            ...
            break;
           get(int ac_capacity,int& ac_count,string account_id)
            ...
            case 2: /** Get Or Create Account **/
                ...
                return_value = get_or_create_account(ac_account_id, ac_balance, ac_capacity, no_of_accounts,  )
