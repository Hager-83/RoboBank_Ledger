...
void bank_summary(void)
 {
    ...
    cout << "out_total_deposits = " <<out_total_withdrawals<<endl;  
    cout << "out_total_deposits = " <<out_total_fees<<endl;  
    cout << "out_total_interest = " <<out_total_interest<<endl;  
    cout << "out_net_exposure = " <<out_total_interest<<endl;
 }
