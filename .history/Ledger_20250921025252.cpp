...
/*************** 3. Apply One Transaction **************/
void apply_all(string tx_account_id[], int tx_type[],int tx_amount_cents[], int tx_count, string account_id,int ac_balance[],int ac_capacity,int& ac_count)
{
    int index   = -1;
    int balance = 0;
    tx_type[] = {0,1,2,3,4,5};
    for(auto i :tx_type)
    {
     //string account_id,int tx_type,unsigned int amount_cents)
        apply_one(tx_account_id, ac_balance, ac_capacity, ac_count, tx_account_id[], tx_type, tx_amount_cents );
    }
