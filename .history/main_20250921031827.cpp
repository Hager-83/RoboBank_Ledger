    ...
    while(true)
    {
        ...
        switch(operation)
        {
            ...
            case 4: /** Apply All Transactions  **/
            {
                ...
                string tx_account_id[tx_count] = {"A00", "A01", "A00"};
                int    tx_type[tx_count]       = {0, 1, 2};          // 0=Deposit, 1=Withdrawal, 2=Fee
                int    tx_amount_cents[tx_count] = {2000, 500, 100};
            ...
            case 5: /** Balance of **/
                ...
                cin.ignore();
                getline(cin, account_id);
                return_value = balance_of(account_id, ac_balance,int ac_count,string account_id)
